...
export default function WishCard({ wish, onClick }: Props) {
  return (
    <div
      onClick={onClick}
      className={`mx-4 mb-3 p-4 rounded-xl border shadow-sm cursor-pointer active:scale-[0.98] transition-transform ${getStatusColor(
        wish.status
      )}`}
    >
      <div className="flex items-start justify-between">
        ...
        <span className="text-xs text-yellow-500 tracking-wider whitespace-nowrap">
